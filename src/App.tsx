...
function App() {
  const AparelhosEletronicos = [
    ...
    {nome: 'AirPods Pro 2', Image: AirPodsPro2Img, descricao: 'Cancelamento ativo de ruído, modo Transparência, chip H2, drivers personalizados, resistência a suor e água (IPX4).', valor: 2.599 },
  ];
  const ServicosCard = [
